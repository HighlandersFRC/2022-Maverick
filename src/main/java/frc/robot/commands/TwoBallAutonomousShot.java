...
public class TwoBallAutonomousShot extends SequentialCommandGroup {
  /** Creates a new TwoBallAutonomousShot. */
  private ShotAdjuster adjuster;
  public TwoBallAutonomousShot(Drive drive, MagIntake magIntake, Shooter shooter, Hood hood, Peripherals peripherals, Lights lights, double hoodPosition, double shooterRPM, double firstBallTimeout, double secondBallTimeout, ShotAdjuster shotAdjuster, double offset, Boolean useList) {
