...
public class SquareDemo extends SequentialCommandGroup {
  /** Creates a new SquareDemo. */
  ...
  public SquareDemo(Drive drive, MagIntake magIntake, Shooter shooter, Hood hood, Peripherals peripherals, Lights lights) {
    ...
    addCommands(new ContinuousAccelerationInterpolation(drive, pathJSON, false), new IntakeBalls(magIntake, lights));
  }
}
