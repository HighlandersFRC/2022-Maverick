...
public class Chezy2BallSteal extends SequentialCommandGroup {
  /** Creates a new Chezy2BallSteal. */
  ...
  public Chezy2BallSteal(Drive drive, MagIntake magIntake, Shooter shooter, Hood hood, Peripherals peripherals, Lights lights) {
    try {
